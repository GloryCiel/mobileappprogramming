...
import com.example.runningapp.databinding.FragmentFindCrewBottomSheetBinding
...
class FindCrewBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private var _binding: FragmentFindCrewBottomSheetBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFindCrewBottomSheetBinding.inflate(inflater, container, false)
        return binding.root
    }
